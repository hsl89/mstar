import pytest
import torch as th
from mstar.attention_cell import gen_mem_attn_mask, gen_self_attn_mask
from mstar.models.bert import BertModel, BertForMLM, BertForPretrain, init_weights
from mstar.utils.torch import share_parameters
