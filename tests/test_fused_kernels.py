...
from mstar.megatron.fused_softmax import AttnMaskType
from mstar.megatron.fused_layer_norm import MixedFusedLayerNorm
...
def test_load_fused_kernels():
    try:
        import mstar.fused_mix_prec_layer_norm_cuda
