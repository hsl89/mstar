...
try:
    from apex.contrib.layer_norm.layer_norm import FastLayerNormFN  # pylint: disable=import-error
    HAVE_PERSIST_LAYER_NORM = True
except ImportError:
    HAVE_PERSIST_LAYER_NORM = False

global fused_mix_prec_layer_norm_cuda  # pylint: disable=global-at-module-level
