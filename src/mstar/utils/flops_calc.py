...
def megatron_lm_formula(activation_checkpointing: bool,
                        vocab_size: int,
                        hidden_size: int,
                        num_layers: int,
                        seq_len: int,
...
def compute_tflops_per_gpu(model_type: str,
                           sec_per_step: int,
                           activation_checkpointing: bool,
                           vocab_size: int,
                           hidden_size: int,
    ...
    assert model_type in ['decoder',
                          'encoder_decoder'], 'Model type not supported'
    ...
    if model_type == 'decoder':
        ...
        assert encoder_seq_len > 0 and encoder_num_layers > 0, 'Must provide separate encoder and decoder info'
