...
class ATMSeq2SeqConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~ATMSeq2SeqModel`. It is used to
    instantiate a ATMSeq2Seq model according to the specified arguments, defining the model architecture.
    ...
    def __init__(
        ...
        **common_kwargs
        ...
        r"""
        :class:`~ATMSeq2Seq` is the configuration class for `ATMSeq2SeqModel`.
