"""
Used to generate index files for each dataloader
"""
...
def add_args(parser):
    ...
    parser.add_argument(
        ...
        type=int,
        required=False,
        help="Number of index files to be generated. This should match the number of GPUS to be used downstream. For example, 8 nodes times 8 gpus is 64 GPUs, so specify 64",
    )
    parser.add_argument(
        "--start_index",
        default=0,
    ...
    parser.add_argument(
        "--output_path",
        default="/home/ubuntu/index_files/",
        type=str,
        required=False,
